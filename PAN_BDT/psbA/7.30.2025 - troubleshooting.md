...
*Notes: embarrassingly I believe I made the same mistake I made on [7.21.2025 - annealing gradient](7.21.2025%20-%20annealing%20gradient.md) where I added my reverse primer twice and did not add any forward primer. This was definetly because I was feeling under the weather but was my last wet lab work day before vacation so I pushed myself to come in- lesson learned. will retry this same experiment set up next experiment. 
...
9. run thermocycler program: *40 cycles takes 2 hours and 26 minutes*
    ...
    3. 46°C for 1 minute
    4. 68°C for <mark style="background: #FFF3A3A6;">45 seconds</mark> _repeat 2-4 for 38 cycles (# of cycles varies depending on input)
