...
- *Not sure what the top band (~1500 bp) is in samples?* *Surprised how the nright the band is across all temperatures? Not sure what is going on* 
	- *the 1500 bp band is also on July 23 gel ([[7.23.2025 - troubleshooting]]) however is it limited to the a specfic temperature range and is might fainter*
