...
# 05/15/2026 
- buy a wetsuit & boots for Belize 
- pick out what fish for the fishing laws game (Belize Outreach)
...
- attend bootcamp 
- create meeting repo 
- finish cleaning up scripts and update read me section 

## Daily To Do List 
- [x] create meeting repo
- [x] clean up old scripts 
- [x] update lab notebook readme 
- [x] attend bootcamp 
# 05/13/2026 
- attend bootcamp 
- transfer old lab book material  
- update readme 
## Daily To Do List
- [x] Attend Bootcamp 
- [x] set up new lab notebook
	- [x] merge old lab notebook files into new template 
	- [ ] update readme - still need to update scripts section 
