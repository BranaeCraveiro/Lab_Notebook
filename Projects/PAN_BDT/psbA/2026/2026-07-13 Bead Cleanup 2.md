*Note: retry of [2026-07-13 Bead Cleanup 1](2026-07-13%20Bead%20Cleanup%201.md) but with 0.5 x bead conc.
trying diluting my samples with molecular water to 50 uL since previous cleanups on these samples didn't work for some reason
