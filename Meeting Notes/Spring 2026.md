# 5/8/2026 Periodic Meeting Notes 
## What I accomplished last week 
- I know what is wrong with my sample tracker code :) 
- Figured out which PSTR samples I need to extract for Caroline 
- Goldwater article was posted this morning (scary haha)
## What I plan to do next week 
### High Priority 
- [ ] Finalize list of samples for Caroline 
	- [ ] pick SSID samples (need to be extracted)
	- [ ] pick CNAT samples (extractions done)
- [ ] Finish DNA Extractions
- [ ] Create sample tracker (fix code)
- [ ] create meeting repo 
### If time: 
- [ ] IDP form 
- [ ] summer weekly plan
...
## to do 
- go thorugh according folder to amke sure columbia is out and belize is in 
- tube labels 
- check datasheets 
- summer plan; what I will do each week 
- find ids that are in smaller df and determine which id is not in both lists 
- make a repo that is meeting with sarah and do not set it up with backup so that sarah has to accept the pull request 
	- 24 hours before the meeting 
	- what i did last week what i will do next week 
	- template in the lab manual 
IDP for summer 
