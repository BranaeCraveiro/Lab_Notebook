## 12/5/2025 w/ Sarah & Caroline
Meeting time next semester: 11 am; start Jan 9th 
### Things to do 
#### read some of Calebs Papers 
#### draft email to caleb about two bands diff sizes 
what to say: 
- blast gave us psba but one a one b 
- we chose these primers 
- show ss of blast results 
- is there a better way to id taxa 
#### figure out nchar thing in code 
- why is consensus count higher than the merged count? 
- better annotate code 
#### draft new pcr protocol 
- mgcl maybe 
...
- top matches were cladocopium w/ 100% identity 
- however I wonder if this in an artifical result since the 1500 (which is cladocopium) has about three times as many bp so it is inflating the cladocopium % identity of the sequence
...
- most studies use ITS2 (DGGE/cloning or SymPortal) as the primary assignment and psbA to confirm/refine it
- cannot seeem to find a paper that uses solely psbA 
...
- having a hard time every paper I am reading is using ITS2 for symbiont id and using psbA as support; starting to realize there is not many coral symbiont papers that do just psbA 
###### Starting looking at papers that use psbA but not neccessarily for coral symbionts
- A thesis paper (was psbA for red algae not corals)  used GenBank to identify psbA sequences
...
- sequence 300 bp and 700 bp band seperately [2025-09-02 - Troubleshooting](../../PAN_BDT/psbA/CNAT/2025-09-02%20-%20Troubleshooting.md)
...
#### 300 bp & 700 bp Bands
My most recent gel ([2025-09-02 - Troubleshooting](../../PAN_BDT/psbA/CNAT/2025-09-02%20-%20Troubleshooting.md)) show a ~300 bp band and a ~700 bp band. However, the paper I got my primer from shares that the psbAncr region was between 500-600 bp. 
