...
### Current Progress 
- updated and finished my poster for the retreat 
- began WDHOF application 
	-  I finished the basic question section, have yet to start the actual project proposal section (yes I am procasinating that lol)
	- next week my teacher is away so I have one less class and will have a lot more time to work on my application 
- wrote draft email to Dr. Mansfield-
	- however waiting to send because she is out of office until monday 
- reran cleaned samples
### Gel Questions 
- I am not sure what to do next regarding my gel 
- the 300bp and 1500 bp bands cleaned but the 700 bp band did not
	- perhaps rerun gel?
	- perhaps used wrong bead ratio?
	- reclean with another sample that displays a 700 bp band?

To do:
- qubit cleaned 700 bp - maybe concentrate it 
- look at sample tubes 
- send samples next week 
- email Leah
...
- https://www.genewiz.com/public/resources/sample-submission-guidelines/sanger-sequencing-sample-submission-guidelines
	- might want to walk through to make sure I am doing it right \
